...
export function Checkbox(props: CheckboxProps) {
  const { register, checked, onChange, children, color = 'blue', ripple = true } = props;
  ...
  return (
    <>
      <label className="inline-flex items-center mx-auto w-64" onClick={handleCheckboxChange}>
        <div
